...
drawGrid (CanvasRenderingContext2D canvas, String color, int stepx, int stepy) {
   context.save();
...
context.beginPath();
context.arc(150, 370, 60, 0, PI*3/2);
context.stroke();

context.beginPath();
context.arc(475, 370, 60, 0, PI*3/2);
context.fill();

context.beginPath();
context.arc(820, 370, 60, 0, PI*3/2);
context.stroke();
context.fill();
...
context.beginPath();
context.arc(150, 550, 60, 0, PI*3/2);
context.closePath();
context.stroke();

context.beginPath();
context.arc(475, 550, 60, 0, PI*3/2);
context.closePath();
context.fill();

context.beginPath();
context.arc(820, 550, 60, 0, PI*3/2);
context.closePath();
context.stroke();
context.fill();
